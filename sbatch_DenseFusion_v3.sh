...
#SBATCH --output=sbatch_output_v3.txt
...
python3 ./tools/train_v3.py --dataset linemod --dataset_root "/ssd_scratch/cvit/amoghtiwari/densefusion/data/Linemod_preprocessed" --outf "/ssd_scratch/cvit/amoghtiwari/densefusion/checkpoints/"
